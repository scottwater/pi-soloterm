...
Use solo_status before relying on Solo-backed delegation, todos, scratchpads, or process status. If Solo MCP is unavailable, explain that Solo must be running with MCP enabled instead of improvising manual panes.
</SOLOTERM>
`.trim();
